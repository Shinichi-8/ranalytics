...
x
x[22:25]
x[seq(1,50,2)] #print odd numbers
x
...
(x5a = c(3,5.5))
class(x5a)
as.integer(x5a) #removes decimal point
...
x6[-c(1:10, 15:20)] #removed the elements in the bracket
...
sort(x6)
sort(x6[-c(1,2)]) #removed first two values (16,28)
...
x
diff(x) #difference between each successive values
x = NULL
x
#NULL
x[4]
